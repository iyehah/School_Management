...
class ResultsManagement:
    ...
    def display_student_info(self, name, code_rim, classroom, subjects_list):
        ...
        examen_type_combobox = ttk.Combobox(examen_type_frame, values=[
            "devoir 1", "examen 1", "devoir 2", "examen 2", "devoir 3", "examen 3"
        ])
        examen_type_combobox.pack(padx=5, pady=5)
        ...
        for subject in subjects_list:
            ...
            ttk.Entry(subject_frame, width=5).pack(side='left', padx=5)
